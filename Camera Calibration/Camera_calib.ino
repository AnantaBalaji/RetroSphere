...
void IRAM_ATTR counter_interrupt(){
  if(LED_STATE)
  {
...
void setup() {
  ...
  */
  ...
  fps_timer = timerBegin(0, 80, true); //set Prescale
  timerAttachInterrupt(fps_timer, &counter_interrupt, true); 
  timerAlarmWrite(fps_timer, FRAME_RATE_MICROSECONDS_FLOAT, true);
  timerAlarmEnable(fps_timer);
}
